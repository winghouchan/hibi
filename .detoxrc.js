...
module.exports = {
  ...
  apps: {
    'ios.debug': {
      type: 'ios.app',
      binaryPath: 'ios/build/Build/Products/Debug-iphonesimulator/Hibi.app',
      build:
        'xcodebuild -workspace ios/Hibi.xcworkspace -scheme Hibi -configuration Debug -sdk iphonesimulator -derivedDataPath ios/build',
    },
    'ios.release': {
      type: 'ios.app',
      binaryPath: 'ios/build/Build/Products/Release-iphonesimulator/Hibi.app',
      build:
        'xcodebuild -workspace ios/Hibi.xcworkspace -scheme Hibi -configuration Release -sdk iphonesimulator -derivedDataPath ios/build',
    },
    'android.debug': {
      type: 'android.apk',
